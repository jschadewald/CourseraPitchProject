...
```{r modelPiles, fig.height=4, fig.width=7}
...
mean = ```0*.75 + 1*.2375 + 2*.0125``` = `r 0*.75 + 1*.2375 + 2*.0125`

var = ```0^2*.75 + 1^2*.2375 + 2^2*.0125 -.2625^2``` = `r 0^2*.75 + 1^2*.2375 + 2^2*.0125 - .2625^2`
